...
// Hanya izinkan admin, pimpinan, pengawas, atau karyawan (jika mencetak miliknya sendiri)
$role = $_SESSION['role'];
if ($role != 'admin' && $role != 'pimpinan' && $role != 'pengawas' && $role != 'karyawan') {
    die("Akses ditolak. Peran tidak dikenali.");
}
...
if ($role == 'karyawan') {
    if ($user_id != $_SESSION['user_id']) {
        die("Akses ditolak. Anda hanya dapat mencetak laporan absensi Anda sendiri.");
    }
}
