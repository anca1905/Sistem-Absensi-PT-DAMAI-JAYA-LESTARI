...
<style>
    ...
    /* Menu Grid (Bisa dibuat grid 2 kolom atau list, karena sketsa susun bawah kita percantik listnya) */
    .menu-list {
        display: flex;
...
<div class="animate-up" style="animation-delay: 0.1s;">
    ...
    <div class="welcome-card">
        ...
        <p class="welcome-subtitle">Ringkasan aktivitas dan laporan hari ini</p>
    </div>

    <!-- 6 Stacked Menu Buttons Sesuai Sketsa 1 -->
    <div class="menu-list">
        ...
        <a href="form_harian.php" class="menu-btn">
            <div class="menu-icon">
            ...
            <div class="menu-text">Laporan Absen Karyawan</div>
            <svg class="menu-arrow" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"></polyline></svg>
        </a>
