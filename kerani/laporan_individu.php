...
$q_user = mysqli_query($conn, "SELECT name FROM users WHERE id=$uid");
...
<div class="animate-up">
    <a href="laporan_keseluruhan.php" class="btn-back">
            ...
            <table class="lk-table">
                <thead>
                    ...
                    <tr>
                        ...
                        <?php if ($tipe === 'T1'): ?>
                            <th colspan="7" class="th-o2">HASIL KERJA (LANGSIR)</th>
                        <?php elseif ($tipe === 'T2'): ?>
